...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: The sequence of names doesn't match what is expected for the output.
    ...
    // Defect(s) Found:  New players added midway are not being integrated the right way.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The code doesn't handle infinite turns the way it should.
    ...
    // Defect(s) Found: The same with the last test, having a problem with the infinite turns.
    ...
    // Defect(s) Found: Does not give the proper exception when the queue is empty.
