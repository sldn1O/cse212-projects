public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Removing data from index 1 instead of 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: enqueue is trying to go at the front
    ...
    private void Enqueue(int value) {
        _queue.Add(value); // Needs to be add and not insert. Remove 0,
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; //start with 0 not 1
        _queue.RemoveAt(0); //start with 0 not 1
        return value;
    }
}